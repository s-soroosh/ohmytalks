...
var app = (function () {
    ...
    // (17:2) <Card style="max-width:350px;">
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 17, 4, 365);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(17:2) <Card style=\\\"max-width:350px;\\\">",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$1, 15, 0, 300);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 50, 6, 1459);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_default_slot(ctx) {
    	...
    	card0 = new TalkCard({ props: { name: "JS1" }, $$inline: true });
    	card0.$on("click", /*onCardSelection*/ ctx[1]);
    	card1 = new TalkCard({ props: { name: "JS2" }, $$inline: true });
    	card1.$on("click", /*onCardSelection*/ ctx[1]);
    	card2 = new TalkCard({ props: { name: "JS3" }, $$inline: true });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-1xsevcz");
