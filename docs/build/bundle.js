    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 26, 6, 569);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_icon_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 19, 6, 405);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_title_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file, 25, 6, 525);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 48, 6, 1343);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 39, 4, 1002);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file, 40, 17, 1041);
    			add_location(p, file, 40, 4, 1028);
    		},
    		m: function mount(target, anchor) {
